...
//
  ...
  router.get('/staff-app/' + v + '/applications/assessor/tasklist-3127-completed', function (req,res) {
    ...
    req.session.data['aac-3127-pat-training'] = "Pass"
    req.session.data['aac-3127-pat-wheretrained'] = "Pass"
    req.session.data['aac-3127-dat-sectors'] = "Pass"
    req.session.data['aac-3127-dat-management-hierarchy'] = "Pass"
    res.redirect('/staff-app/' + v + '/applications/assessor/tasklist-3127')
  })
  ...
  router.get('/staff-app/' + v + '/applications/assessor/clarify/clarify-3127-completed', function (req,res) {
    ...
    router.post('/staff-app/' + v + '/applications/assessor/3127/pya/subcontractor', function (req,res) {
			res.redirect('/staff-app/' + v + '/applications/assessor/tasklist-3127')
		})
...
//
  ...
  router.post('/staff-app/' + v + '/applications/assessor/3127/submit/submit-confirm', function (req,res) {
    if (req.session.data['aac-3127-outcome-confirm'] === 'No') {
      ...
      req.session.data['aac-mod-3127-pya-equality'] = "Pass"
      ...
      req.session.data['aac-mod-3127-pat-training'] = "Pass"
...
//
  ...
  router.get('/staff-app/' + v + '/applications/assessor/moderate/tasklist-3127-completed-with-fails', function (req,res) {
    ...
    req.session.data['aac-mod-3127-pya-healthandsafety'] = "Pass"
    req.session.data['aac-mod-3127-pya-healthandsafety-responsible'] = "Pass"
    req.session.data['aac-mod-3127-pya-subcontractor'] = "Fail"
    req.session.data['aac-mod-3127-rte-engage'] = "Pass"
    req.session.data['aac-mod-3127-rte-engagerelationships'] = "Pass"
    req.session.data['aac-mod-3127-rte-engageresponsible'] = "Pass"
    req.session.data['aac-mod-3127-rte-engagepromote'] = "Pass"
  ...
  router.get('/staff-app/' + v + '/applications/assessor/moderate/show-in-tab-view', function (req,res) {
    req.session.data['apr3127'] = "submitted"
    req.session.data['aac-new-count'] = 3
    req.session.data['aac-inprogress-count'] = 4
    req.session.data['aac-moderation-count'] = 2
    req.session.data['aac-mod-3127-pya-equality'] = "Pass"
    req.session.data['aac-mod-3127-pya-safeguarding'] = "Pass"
    req.session.data['aac-mod-3127-pya-safeguarding-responsible'] = "Pass"
    req.session.data['aac-mod-3127-pya-prevent-responsible'] = "Pass"
